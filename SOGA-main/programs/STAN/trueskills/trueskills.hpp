...
class trueskills_model final : public model_base_crtp<trueskills_model> {
 ...
 public:
  ...
  inline std::string model_name() const final { return "trueskills_model"; }
  ...
  trueskills_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "trueskills_model_namespace::trueskills_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "trueskills_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      perfB = in__.template read_constrain_ub<local_scalar_t__, jacobian__>(
                perfA, lp__);
      local_scalar_t__ perfC = DUMMY_VAR__;
      current_statement__ = 6;
      perfC = in__.template read_constrain_ub<local_scalar_t__, jacobian__>(
                perfA, lp__);
      {
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "trueskills_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
  ...
  inline void transform_inits(const stan::io::var_context& context,
                              ...
                              std::vector<double>& vars,
                              std::ostream* pstream__ = nullptr) const {
     constexpr std::array<const char*, 6> names__{"skillA", "skillB",
      "skillC", "perfA", "perfB", "perfC"};
