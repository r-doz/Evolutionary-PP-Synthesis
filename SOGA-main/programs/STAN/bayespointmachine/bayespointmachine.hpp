...
class bayespointmachine_model final : public model_base_crtp<bayespointmachine_model> {
 ...
 public:
  ...
  inline std::string model_name() const final { return "bayespointmachine_model"; }
  ...
  bayespointmachine_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "bayespointmachine_model_namespace::bayespointmachine_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "bayespointmachine_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      norm1 = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(
                0, lp__);
      local_scalar_t__ norm2 = DUMMY_VAR__;
      current_statement__ = 3;
      norm2 = in__.template read_constrain_ub<local_scalar_t__, jacobian__>(
                0, lp__);
      local_scalar_t__ norm3 = DUMMY_VAR__;
      current_statement__ = 4;
      norm3 = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(
                0, lp__);
      local_scalar_t__ norm4 = DUMMY_VAR__;
      current_statement__ = 5;
      norm4 = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(
                0, lp__);
      local_scalar_t__ norm5 = DUMMY_VAR__;
      current_statement__ = 6;
      norm5 = in__.template read_constrain_ub<local_scalar_t__, jacobian__>(
                0, lp__);
      local_scalar_t__ norm6 = DUMMY_VAR__;
      current_statement__ = 7;
      norm6 = in__.template read_constrain_ub<local_scalar_t__, jacobian__>(
                0, lp__);
      {
        ...
        for (int i = 1; i <= 3; ++i) {
          ...
          lp_accum__.add(
            stan::math::normal_lpdf<propto__>(
              stan::model::rvalue(w, "w", stan::model::index_uni(i)), 0, 1));
        }
        current_statement__ = 11;
        lp_accum__.add(
          stan::math::normal_lpdf<propto__>(norm1,
            (((stan::model::rvalue(feat1, "feat1", stan::model::index_uni(1))
              ...
              (stan::model::rvalue(feat3, "feat3", stan::model::index_uni(1))
                * stan::model::rvalue(w, "w", stan::model::index_uni(3)))),
            0.1));
        current_statement__ = 12;
        lp_accum__.add(
          stan::math::normal_lpdf<propto__>(norm2,
            (((stan::model::rvalue(feat1, "feat1", stan::model::index_uni(2))
                * stan::model::rvalue(w, "w", stan::model::index_uni(1))) +
               (stan::model::rvalue(feat2, "feat2",
                  stan::model::index_uni(2)) *
                 stan::model::rvalue(w, "w", stan::model::index_uni(2)))) +
              (stan::model::rvalue(feat3, "feat3", stan::model::index_uni(2))
                * stan::model::rvalue(w, "w", stan::model::index_uni(3)))),
            0.1));
        current_statement__ = 13;
        lp_accum__.add(
          stan::math::normal_lpdf<propto__>(norm3,
            (((stan::model::rvalue(feat1, "feat1", stan::model::index_uni(3))
                * stan::model::rvalue(w, "w", stan::model::index_uni(1))) +
               (stan::model::rvalue(feat2, "feat2",
                  stan::model::index_uni(3)) *
                 stan::model::rvalue(w, "w", stan::model::index_uni(2)))) +
              (stan::model::rvalue(feat3, "feat3", stan::model::index_uni(3))
                * stan::model::rvalue(w, "w", stan::model::index_uni(3)))),
            0.1));
        current_statement__ = 14;
        lp_accum__.add(
          stan::math::normal_lpdf<propto__>(norm4,
            (((stan::model::rvalue(feat1, "feat1", stan::model::index_uni(4))
                * stan::model::rvalue(w, "w", stan::model::index_uni(1))) +
               (stan::model::rvalue(feat2, "feat2",
                  stan::model::index_uni(4)) *
                 stan::model::rvalue(w, "w", stan::model::index_uni(2)))) +
              (stan::model::rvalue(feat3, "feat3", stan::model::index_uni(4))
                * stan::model::rvalue(w, "w", stan::model::index_uni(3)))),
            0.1));
        current_statement__ = 15;
        lp_accum__.add(
          stan::math::normal_lpdf<propto__>(norm5,
            (((stan::model::rvalue(feat1, "feat1", stan::model::index_uni(5))
                * stan::model::rvalue(w, "w", stan::model::index_uni(1))) +
               (stan::model::rvalue(feat2, "feat2",
                  stan::model::index_uni(5)) *
                 stan::model::rvalue(w, "w", stan::model::index_uni(2)))) +
              (stan::model::rvalue(feat3, "feat3", stan::model::index_uni(5))
                * stan::model::rvalue(w, "w", stan::model::index_uni(3)))),
            0.1));
        current_statement__ = 16;
        lp_accum__.add(
          stan::math::normal_lpdf<propto__>(norm6,
            (((stan::model::rvalue(feat1, "feat1", stan::model::index_uni(6))
                * stan::model::rvalue(w, "w", stan::model::index_uni(1))) +
               (stan::model::rvalue(feat2, "feat2",
                  stan::model::index_uni(6)) *
                 stan::model::rvalue(w, "w", stan::model::index_uni(2)))) +
              (stan::model::rvalue(feat3, "feat3", stan::model::index_uni(6))
                * stan::model::rvalue(w, "w", stan::model::index_uni(3)))),
            0.1));
      }
    } catch (const std::exception& e) {
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "bayespointmachine_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
  ...
  inline void transform_inits_impl(VecVar& params_r__, VecI& params_i__,
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= 3; ++sym1__) {
        w[(sym1__ - 1)] = in__.read<local_scalar_t__>();
      }
      out__.write(w);
      local_scalar_t__ norm1 = DUMMY_VAR__;
  ...
  inline void transform_inits(const stan::io::var_context& context,
                              ...
                              std::vector<double>& vars,
                              std::ostream* pstream__ = nullptr) const {
     constexpr std::array<const char*, 7> names__{"w", "norm1", "norm2",
      "norm3", "norm4", "norm5", "norm6"};
      const std::array<Eigen::Index, 7> constrain_param_sizes__{3, 1, 
       1, 1, 1, 1, 1};
